...
export default function Dropdown({ options, onSelect, defaultOptionIndex }: Props) {
  ...
  return (
    <div>
      <button
        type="button"
        className="inline-flex justify-center w-full rounded-md border border-gray-200 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-gray-600"
        id="menu-button"
        aria-expanded="true"
        aria-haspopup="true"
